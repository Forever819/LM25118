...
#define W2812_OVT_COLOR 0xFFFFFF
...
void Digital_Power_State_Update(void)
{
    ...
    case OCP:
        ...
        break;
    case OVT:
        printf("over temperature triggered!\r\n");
        BSP_WS2812_Set_Color(W2812_OVT_COLOR);
        Buzzer_Play(2200, 100);
        Buzzer_Play(0, 100);
        Buzzer_Play(2200, 100);
        OLED_UI_OVT();
