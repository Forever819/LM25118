...
/***************************************************************************************
 * ��������Խ�Э�Ƽ�0.96��OLED��ʾ����������-4���OLEDI2C�ӿ�V1.2 ������CH32V003
 * ���������鿴��ʹ�ú��޸ģ���Ӧ�õ��Լ�����Ŀ֮��
 * �����Ȩ�齭Э�Ƽ����У��κ��˻���֯���ý����Ϊ����
 *
 ***************************************************************************************
...
#define Use_HardwareIIC  // ������ģ��iic��ע��
// #define Use_DMA
...
void OLED_Init (void) {
    ...
    // ʹ���ڲ�RAM������ַģʽ ���ܻᵼ���ϴδ���δ���  OLED �ڲ���/ҳ��ַδ����
    // ������Ҫ����ҳ���е�ַ
    OLED_WriteCommand (0x21);  // ��������ʼ�ͽ�����ַ
    OLED_WriteCommand (0);     // ��ʼ��
    OLED_WriteCommand (127);   // ������

    OLED_WriteCommand (0x22);  // ����ҳ��ʼ�ͽ�����ַ
    OLED_WriteCommand (0);     // ��ʼҳ
    OLED_WriteCommand (7);     // ����ҳ

    OLED_WriteCommand (0x20);  // ˮƽ��ַģʽ
...
void OLED_SetHorizontalScroll (uint8_t direction, uint8_t start_page, uint8_t end_page, uint8_t speed) {
    OLED_WriteCommand (0x26 | direction);  // 0x26=���ң�0x27=����
    OLED_WriteCommand (0x00);              // �����ֽڣ�����Ϊ0��
    OLED_WriteCommand (start_page);        // ��ʼҳ��0-7��
    OLED_WriteCommand (speed);             // �����ٶȣ�0-7��0=������
    OLED_WriteCommand (end_page);          // ����ҳ��0-7��
    OLED_WriteCommand (0x00);              // �����ֽڣ�����Ϊ0��
    OLED_WriteCommand (0xFF);              // �����ֽڣ�����Ϊ0xFF��
}

// ���ô�ֱ+ˮƽ�������Խ��߹�����
void OLED_SetDiagonalScroll (uint8_t direction, uint8_t start_page, uint8_t end_page, uint8_t speed, uint8_t vertical_offset) {
    OLED_WriteCommand (0x29 | direction);  // 0x29=�����ϣ�0x2A=������
    OLED_WriteCommand (0x00);              // �����ֽ�
    OLED_WriteCommand (start_page);        // ��ʼҳ
    OLED_WriteCommand (speed);             // �����ٶ�
    OLED_WriteCommand (end_page);          // ����ҳ
    OLED_WriteCommand (vertical_offset);   // ��ֱƫ������0-63��
}
