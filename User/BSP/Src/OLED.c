...
/***************************************************************************************
 * 本程序改自江协科技0.96寸OLED显示屏驱动程序-4针脚OLEDI2C接口V1.2 适用于CH32V003
...
// #define Use_HardwareIIC  // 若软件模拟iic请注释
//  #define Use_DMA
...
void HAL_I2C_Master_Transmit (u8 addr, u8 *data, u8 len, u16 timeout) {
    // 等待总线空闲
...
#else
        u8 datax = 0x40;
        HAL_I2C_Master_Transmit (0x78, &datax, 1, 100);
        HAL_I2C_Master_Transmit (0x78, Data, Count, 100);
#endif
    }
    return 0;
}
...
#ifdef Use_DMA
// DMA Config
uint8_t OLED_Transfer_Done_Flag = 1;
extern DMA_HandleTypeDef hdma_i2c1_tx;

void HAL_I2C_MasterTxCpltCallback (I2C_HandleTypeDef *hi2c) {
    if (hi2c->Instance == I2C1) {
        OLED_Transfer_Done_Flag = 1;
    }
}
#endif
#else
