...
// LED 颜色定义
#define W2812_CV_COLOR 0xff0000      // Red - CV mode
#define W2812_CC_COLOR 0xFFD700      // Gold - CC mode
#define W2812_IDLE_COLOR 0x001f00    // Dark green - IDLE
...
void LED_Responder_Init(void)
{
    ...
    Event_Bus_Subscribe(EVENT_PROTECTION_OVT, LED_Protection_Handler);
