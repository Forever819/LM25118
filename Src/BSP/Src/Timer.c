 ...
 * @fn      BSP_PWM_Init
 *
 * @brief   TIM1 is initialized as a PWM output, and the output is filtered by a second-order low-pass filter to become a DAC.
 *
 * @param   none
 *          
 *
 ...
 * @fn      BSP_PWM_Set_CCR
 *
 * @brief   Set the TIM1 PWM duty cycle.
 *
 * @param   ccr - PWM duty cycle.
 *          
 *
 * @return  none
 */
